...
mirrorlist: mirmon
	...
	bin/create_mirrorlist.py mirrors.masterlist virtuozzo/releases/factory/x86_64/os/ > /var/www/html/virtuozzo/mirrorlists/7.0/releases-os.mirrorlist
	bin/create_mirrorlist.py mirrors.masterlist virtuozzo/releases/factory/x86_64/debug/ > /var/www/html/virtuozzo/mirrorlists/7.0/releases-debug.mirrorlist
