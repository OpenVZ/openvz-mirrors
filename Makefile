...
mirrorlist:
	...
	bin/create_mirrorlist.py ${MASTER} kernel/branches/rhel4-2.6.9/current/ > ${WWWPATH}/kernel/mirrors-rhel4-2.6.9
	bin/create_mirrorlist.py ${MASTER} kernel/branches/rhel5-2.6.18/current/ > ${WWWPATH}/kernel/mirrors-rhel5-2.6.18
	bin/create_mirrorlist.py ${MASTER} kernel/branches/rhel5-2.6.18-testing/current/ > ${WWWPATH}/kernel/mirrors-rhel5-2.6.18-testing
	bin/create_mirrorlist.py ${MASTER} kernel/branches/rhel6-2.6.32/current/ > ${WWWPATH}/kernel/mirrors-rhel6-2.6.32
	bin/create_mirrorlist.py ${MASTER} kernel/branches/rhel6-2.6.32-testing/current/ > ${WWWPATH}/kernel/mirrors-rhel6-2.6.32-testing
